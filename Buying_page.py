...
def display_stock():
    ...
    x = 150
    y = 50
#We use the images list and append items to it because otherwise the photos won't appear, Tkinter bug
    for item_name, item_info in info.items():
        ...
        if item_info["quantity"] > 0:
            ...
            item_btn = Button(root, text = "Buy", font = ("Comic sans MS", 12), bg = "green",
                              fg = "white", width = 5, command = lambda item_name = item_name: buy_products(item_name))
